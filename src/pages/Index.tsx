    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        <section className="container py-16 md:py-24">
          ...
          <div className="grid sm:grid-cols-3 gap-3 mt-14 max-w-3xl mx-auto">
            {[
              ["3", "Role dashboards"],
              ["4", "Ride statuses"],
              ["0", "Maps or payment setup"],
            ].map(([value, label]) => (
              <div key={label} className="rounded-lg border bg-card p-5 text-center shadow-card">
